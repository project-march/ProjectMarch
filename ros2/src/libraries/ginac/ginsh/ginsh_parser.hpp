...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_QUOTE = 262,                 /* T_QUOTE  */
    T_QUOTE2 = 263,                /* T_QUOTE2  */
    T_QUOTE3 = 264,                /* T_QUOTE3  */
    T_EQUAL = 265,                 /* T_EQUAL  */
    T_NOTEQ = 266,                 /* T_NOTEQ  */
    T_LESSEQ = 267,                /* T_LESSEQ  */
    T_GREATEREQ = 268,             /* T_GREATEREQ  */
    T_QUIT = 269,                  /* T_QUIT  */
    T_WARRANTY = 270,              /* T_WARRANTY  */
    T_PRINT = 271,                 /* T_PRINT  */
    T_IPRINT = 272,                /* T_IPRINT  */
    T_PRINTLATEX = 273,            /* T_PRINTLATEX  */
    T_PRINTCSRC = 274,             /* T_PRINTCSRC  */
    T_TIME = 275,                  /* T_TIME  */
    T_XYZZY = 276,                 /* T_XYZZY  */
    T_INVENTORY = 277,             /* T_INVENTORY  */
    T_LOOK = 278,                  /* T_LOOK  */
    T_SCORE = 279,                 /* T_SCORE  */
    T_COMPLEX_SYMBOLS = 280,       /* T_COMPLEX_SYMBOLS  */
    T_REAL_SYMBOLS = 281,          /* T_REAL_SYMBOLS  */
    NEG = 282                      /* NEG  */
  };
