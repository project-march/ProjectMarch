...
HardwareBuilder::HardwareBuilder(AllowedRobot robot, bool
                                                         remove_fixed_joints_from_ethercat_train)
    : HardwareBuilder(robot.getFilePath(), remove_fixed_joints_from_ethercat_train)
{
}
...
HardwareBuilder::HardwareBuilder(const std::string& yaml_path, bool
remove_fixed_joints_from_ethercat_train)
