"""Author: Katja Schmal, MVI & Marco Bak, MVIII & Andrew Hutani, MIX & Pleuntje Brons, MIX"""
import getpass
import socket
...
class TestJointsInputDeviceController:
    """
    ...
    def publish_mode(self, mode: int) -> None:
        ...
        self._requested_mode.actuated_joint.data = self._actuated_joint
    ...
    def set_actuated_joint(self, joint: str) -> None:
        """Set the actuated joint."""
        self._actuated_joint = joint
        self._node.get_logger().info(f"Actuated joint set to {joint}")
    ...
    def store_available_modes(self, future) -> None:
        ...
        self._ipd.set_current_mode(future.result().current_mode.mode)
