...
public:
    ...
    /**
     * @brief Fills the joint motor controller state message with updated values.
     *
     * @param msg The reference to the joint motor controller state message that we fill up.
