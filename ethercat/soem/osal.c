...
int march_osal_thread_create(void *thandle, int stacksize, void(*func)(void*), char* (*funcPtr)(const long int*) )
{
   return osal_thread_create(thandle, stacksize, (void*)func, (void*)funcPtr);
}
