...
alias march_build_all='sfox && cm2 && pushd src/libraries/bluespace_ai_xsens_ros_mti_driver/lib/xspublic && make && popd \
&& mkdir -p src/libraries/ginac/build && pushd src/libraries/ginac/build && cmake .. && make && make install && popd && colcon build --symlink-install'
