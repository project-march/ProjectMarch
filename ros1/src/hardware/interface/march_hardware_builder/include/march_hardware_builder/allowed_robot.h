...
public:
  ...
  std::string getFilePath()
  {
    ...
    {
      return base_path.append("/robots/march6.yaml");
    }
    ...
    {
      return base_path.append("/robots/test_joint_rotational_odrive.yaml");
    }
    else if (this->value == AllowedRobot::test_joint_linear_odrive)
    {
      return base_path.append("/robots/test_joint_linear_odrive.yaml");
    }
