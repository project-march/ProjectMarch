...
void ConvexPlaneExtractionROS::callback(const grid_map_msgs::GridMap& message) {
  ...
  m_boundary_pub.publish(convertBoundariesToRosMarkers(planar_terrain.planarRegions, planar_terrain.gridMap.getFrameId(),
                                                       planar_terrain.gridMap.getTimestamp(), line_width));
  m_inset_pub.publish(convertInsetsToRosMarkers(planar_terrain.planarRegions, planar_terrain.gridMap.getFrameId(),
                                                planar_terrain.gridMap.getTimestamp(), line_width));
