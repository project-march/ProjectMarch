...
{
  ASSERT_THROW(march::IMotionCube(1, nullptr, std::move(this->mock_incremental_encoder), this->sw_file_empty_,
...
{
  ASSERT_THROW(march::IMotionCube(1, std::move(this->mock_absolute_encoder), nullptr, this->sw_file_empty_,
                                  march::ActuationMode::unknown),
               std::invalid_argument);
}
...
TEST_F(IMotionCubeTest, SlaveIndexOne)
{
  march::IMotionCube imc(1, std::move(this->mock_absolute_encoder), std::move(this->mock_incremental_encoder),
                         this->sw_file_empty_, march::ActuationMode::unknown);
...
{
  march::IMotionCube imc(1, std::move(this->mock_absolute_encoder), std::move(this->mock_incremental_encoder),
                         this->sw_file_empty_, march::ActuationMode::torque);
...
{
  march::IMotionCube imc(1, std::move(this->mock_absolute_encoder), std::move(this->mock_incremental_encoder),
                         this->sw_file_empty_, march::ActuationMode::position);
