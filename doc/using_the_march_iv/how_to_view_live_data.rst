...
As configuring a configuration can be time consuming, we have created a :march-iv:`configuration folder<march_launch/rqt_multiplot>` with commonly used configurations to easily visualize the data you want.
