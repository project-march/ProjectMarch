...
#define XS_DID_TYPEL_FIS1100EVK			0x00000000
#define XS_DID_TYPE_FIS1100EVK			(XS_DID_TYPEH_FAIRCHILD_DEVICE|XS_DID_TYPEL_FIS1100EVK)
#define XS_DID_FIS1100EVK(did)			((did & XS_DID_TYPEH_MASK) == XS_DID_TYPE_FIS1100EVK)
