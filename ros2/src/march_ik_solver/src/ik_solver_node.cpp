...
void IKSolverNode::configureIKSolverParameters()
{
    ...
    std::vector<double> actuator_lower_error_soft_limits = get_parameter("actuator_lower_error_soft_limits").as_double_array();
    std::vector<double> actuator_upper_error_soft_limits = get_parameter("actuator_upper_error_soft_limits").as_double_array();
