...
class TestMarchSafetyConnectionLost(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node.get_logger().info(str(self.thresholds))
    ...
    def test_below_specific_threshold(self):
        ...
        self.wait_for_node_startup('test_joint1')

        self.publish_temperature(publisher,
                                 self.thresholds['temperature_thresholds_non_fatal']
                                 [joint_name] - 1)
    ...
    def test_all_thresholds_set(self):
        ...
        self.assertTrue(self.wait_for_parameter_availability(set(parameter_names + ['use_sim_time', 'default_temperature_threshold'])),
