...
std::unique_ptr<march::MarchRobot> build(AllowedRobot robot, bool
...
int main(int argc, char** argv)
{
    ...
    MarchHardwareInterface march(build(selected_robot, remove_fixed_joints_from_ethercat_train), reset_imc);
