...
ODrivePDOmap::ObjectMap ODrivePDOmap::mosi_objects_axis_0 = {
    ...
    { ODriveObjectName::RequestedState, ODriveObject(/*offset=*/16, /*length=*/32) },
};

ODrivePDOmap::ObjectMap ODrivePDOmap::mosi_objects_axis_1 = {
    { ODriveObjectName::TargetTorque, ODriveObject(/*offset=*/20, /*length=*/32) },
    { ODriveObjectName::TargetPosition, ODriveObject(/*offset=*/24, /*length=*/32) },
    { ODriveObjectName::FuzzyTorque, ODriveObject(/*offset=*/28, /*length=*/32) },
    { ODriveObjectName::FuzzyPosition, ODriveObject(/*offset=*/32, /*length=*/32) },
