...
extlinks = {
    ...
    "hardware-interface": (gitlab_root + ros2_src + "march_hardware_interface/%s", ""),
    "input-device": (gitlab_root + "input-device/-/tree/main/%s", ""),
    "march": (gitlab_root + ros2_src + "%s", ""),
    "monitor": (gitlab_root + ros2_src + "march_monitor/%s", ""),
    "simulation": (gitlab_root + ros2_src + "march_simulation_cpp/%s", ""),
    "gait-files": (gitlab_root + ros2_src + "march_gait_files/%s", ""),
    "ethercat-slaves": (gitlab_root + "ethercat-slaves/-/tree/main/%s", ""),
    "gait-generation": (gitlab_root + ros2_src + "march_rqt_gait_generator/%s", ""),
