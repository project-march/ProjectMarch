...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_1
    = { { ODriveObjectName::AbsolutePosition, ODriveObject(/*offset=*/48, /*length=*/32) },
          ...
          { ODriveObjectName::Torque, ODriveObject(/*offset=*/96, /*length=*/32) } };

ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_none
    = { { ODriveObjectName::OdriveError, ODriveObject(/*offset=*/96, /*length=*/32) },
          { ODriveObjectName::Heel_right, ODriveObject(/*offset=*/100, /*length=*/32) },
          { ODriveObjectName::Heel_left, ODriveObject(/*offset=*/104, /*length=*/32) },
          { ODriveObjectName::Met1, ODriveObject(/*offset=*/108, /*length=*/32) },
          { ODriveObjectName::Hallux, ODriveObject(/*offset=*/112, /*length=*/32) },
          { ODriveObjectName::Met3, ODriveObject(/*offset=*/116, /*length=*/32) },
          { ODriveObjectName::Toes, ODriveObject(/*offset=*/120, /*length=*/32) },
          { ODriveObjectName::Met5, ODriveObject(/*offset=*/124, /*length=*/32) },
          { ODriveObjectName::Arch, ODriveObject(/*offset=*/128, /*length=*/32) },
          { ODriveObjectName::Rfix, ODriveObject(/*offset=*/132, /*length=*/32) } };
