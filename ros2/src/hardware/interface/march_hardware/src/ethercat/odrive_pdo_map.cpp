...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_0
    = { { ODriveObjectName::AbsolutePosition, ODriveObject(/*offset=*/0, /*length=*/32) },
          ...
          { ODriveObjectName::MotorTemperature, ODriveObject(/*offset=*/36, /*length=*/32) },
          { ODriveObjectName::ShadowCount, ODriveObject(/*offset=*/40, /*length=*/32) } };

ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_1
    = { { ODriveObjectName::AbsolutePosition, ODriveObject(/*offset=*/44, /*length=*/32) },
          { ODriveObjectName::Current, ODriveObject(/*offset=*/48, /*length=*/32) },
          { ODriveObjectName::MotorVelocity, ODriveObject(/*offset=*/52, /*length=*/32) },
          { ODriveObjectName::AxisError, ODriveObject(/*offset=*/56, /*length=*/32) },
          { ODriveObjectName::MotorError, ODriveObject(/*offset=*/60, /*length=*/32) },
          { ODriveObjectName::DieBOSlaveError, ODriveObject(/*offset=*/64, /*length=*/32) },
          { ODriveObjectName::EncoderError, ODriveObject(/*offset=*/68, /*length=*/32) },
          { ODriveObjectName::ControllerError, ODriveObject(/*offset=*/72, /*length=*/32) },
          { ODriveObjectName::AxisState, ODriveObject(/*offset=*/76, /*length=*/32) },
          { ODriveObjectName::MotorTemperature, ODriveObject(/*offset=*/80, /*length=*/32) },
          { ODriveObjectName::ShadowCount, ODriveObject(/*offset=*/84, /*length=*/32) } };
...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_none
    = { { ODriveObjectName::OdriveTemperature, ODriveObject(/*offset=*/88, /*length=*/32) },
          { ODriveObjectName::OdriveError, ODriveObject(/*offset=*/92, /*length=*/32) } };
...
ODrivePDOmap::ObjectMap ODrivePDOmap::mosi_objects_axis_1 = {
    { ODriveObjectName::TargetTorque, ODriveObject(/*offset=*/8, /*length=*/32) },
    { ODriveObjectName::RequestedState, ODriveObject(/*offset=*/12, /*length=*/32) },
};
