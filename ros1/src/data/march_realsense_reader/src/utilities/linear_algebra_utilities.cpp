    ...
    const pcl::Normal& input_normal, pcl::Normal& normalized_normal)
{
    ...
    normalized_normal.normal_x
        = input_normal.normal_x / float(input_normal_norm);
    normalized_normal.normal_y
        = input_normal.normal_y / float(input_normal_norm);
    normalized_normal.normal_z
        = input_normal.normal_z / float(input_normal_norm);
