...
RUN apt update && apt upgrade -y && apt install -y ros-noetic-ros-base ros-foxy-ros-base
...
RUN python3 -m pip install mock argcomplete pytest-repeat pytest-rerunfailures pytest

# Install Python linters
RUN python3 -m pip install black flake8-black
