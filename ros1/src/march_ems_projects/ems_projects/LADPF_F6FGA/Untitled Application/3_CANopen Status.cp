...
SHOWVAR 1 471 4 580 40  0 "ECAT_SM" "" 0.000000000e+000 1.000000000e+003 0 1 %0 "ECAT_SM" 0
...
SHOWVAR 1 471 283 580 319  0 "ModesOpDisplay" "" 0.000000000e+000 1.000000000e+003 0 1 %0 "ModesOpDisplay" 0
...
SHOWVAR 1 471 119 580 155  0 "sts_ds402" "" 0.000000000e+000 1.000000000e+003 0 1 %0 "sts_ds402" 0
...
BIT 1 39 29 75 65  0 "SRL" "SRL[bit 15]" 15 0 0 0
BIT 1 54 29 90 65  0 "SRL" "SRL[bit 14]" 14 0 0 0
BIT 1 68 29 104 65  0 "SRL" "SRL[bit 13]" 13 0 0 0
BIT 1 82 29 118 65  0 "SRL" "SRL[bit 12]" 12 0 0 0
BIT 1 96 29 132 65  0 "SRL" "SRL[bit 11]" 11 0 0 0
BIT 1 110 29 146 65  0 "SRL" "SRL[bit 10]" 10 0 0 0
BIT 1 124 29 160 65  0 "SRL" "SRL[bit 9]" 9 0 0 0
BIT 1 138 29 174 65  0 "SRL" "SRL[bit 8]" 8 0 0 0
BIT 1 152 29 188 65  0 "SRL" "SRL[bit 7]" 7 0 0 0
BIT 1 166 29 202 65  0 "SRL" "SRL[bit 6]" 6 0 0 0
BIT 1 180 29 216 65  0 "SRL" "SRL[bit 5]" 5 0 0 0
BIT 1 194 29 230 65  0 "SRL" "SRL[bit 4]" 4 0 0 0
BIT 1 208 29 244 65  0 "SRL" "SRL[bit 3]" 3 0 0 255
BIT 1 222 29 258 65  0 "SRL" "SRL[bit 2]" 2 0 0 0
BIT 1 236 29 272 65  0 "SRL" "SRL[bit 1]" 1 0 0 0
BIT 1 250 29 286 65  0 "SRL" "SRL[bit 0]" 0 0 0 0
...
BIT 1 251 418 287 454  0 "SRL" "SRL[bit 0]" 0 0 0 0
BIT 1 251 395 287 431  0 "SRL" "SRL[bit 1]" 1 0 0 0
BIT 1 251 373 287 409  0 "SRL" "SRL[bit 2]" 2 0 0 0
BIT 1 251 350 287 386  0 "SRL" "SRL[bit 3]" 3 0 0 255
BIT 1 251 327 287 363  0 "SRL" "SRL[bit 4]" 4 0 0 0
BIT 1 251 304 287 340  0 "SRL" "SRL[bit 5]" 5 0 0 0
BIT 1 251 281 287 317  0 "SRL" "SRL[bit 6]" 6 0 0 0
BIT 1 251 258 287 294  0 "SRL" "SRL[bit 7]" 7 0 0 0
BIT 1 251 235 287 271  0 "SRL" "SRL[bit 8]" 8 0 0 0
BIT 1 251 212 287 248  0 "SRL" "SRL[bit 9]" 9 0 0 0
BIT 1 251 189 287 225  0 "SRL" "SRL[bit 10]" 10 0 0 0
BIT 1 251 166 287 202  0 "SRL" "SRL[bit 11]" 11 0 0 0
BIT 1 251 143 287 179  0 "SRL" "SRL[bit 12]" 12 0 0 0
BIT 1 251 120 287 156  0 "SRL" "SRL[bit 13]" 13 0 0 0
TEXT 1 5 75 259 100  "15 - Axis is ON" "Arial" 10 700 0 0 0 34 0 1 14212834
BIT 1 251 98 287 134  0 "SRL" "SRL[bit 14]" 14 0 0 0
BIT 1 251 75 287 111  0 "SRL" "SRL[bit 15]" 15 0 0 0
...
SHOWVAR 1 185 5 294 41  0 "SRL" "" 0.000000000e+000 1.000000000e+003 0 1 %0 "SRL" 0
