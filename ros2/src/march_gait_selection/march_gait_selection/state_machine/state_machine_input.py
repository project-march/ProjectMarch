...
class StateMachineInput(object):
    ...
    def __init__(self, node: Node):
        ...
        self._instruction_subscriber = self._node.create_subscription(GaitInstruction,
                                                                      '/march/input_device/instruction',
                                                                      self._callback_input_device_instruction)
        self._instruction_response_publisher = self._node.create_publisher('/march/input_device/instruction_response',
