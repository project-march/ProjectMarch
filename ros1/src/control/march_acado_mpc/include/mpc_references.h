...
/**
 * \brief Add a sinus reference to the existing reference vector with the following parameters
 * @param reference
 * @param freq
 * @param amplitude
 * @param N
...
/**
 * \brief Add a step reference to the existing reference vector with the following parameters
 * @param reference
 * @param amplitude
 * @param N
 */
