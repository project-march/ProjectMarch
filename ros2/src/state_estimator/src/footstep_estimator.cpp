...
{
    foot_right.position.point.x = right_foot_vec.x + 0.15; // at the start, the CoM is about 0.11 meters in the positive direction, because the 0 is from the right ankle 
    foot_right.position.point.y = right_foot_vec.y;
    foot_right.position.point.z = right_foot_vec.z;

    foot_left.position.point.x = left_foot_vec.x + 0.15; // at the start, the CoM is about 0.11 meters in the positive direction, because the 0 is from the right ankle 
