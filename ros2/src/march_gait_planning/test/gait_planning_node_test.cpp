...
//     test_gait_planning.m_gait_planning.setGaitType(exoState::Stand);
//     test_gait_planning.footPositionsPublish(); 
...
//     test_gait_planning.m_gait_planning.setGaitType(exoState::BootUp); 
//     test_gait_planning.footPositionsPublish(); 
...
//     test_gait_planning.m_gait_planning.setGaitType(exoState::Walk); 
//     test_gait_planning.footPositionsPublish(); 
