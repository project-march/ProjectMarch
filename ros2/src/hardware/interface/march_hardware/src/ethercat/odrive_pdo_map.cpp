...
ODrivePDOmap::ObjectMap ODrivePDOmap::mosi_objects_axis_0 = {
    ...
    { ODriveObjectName::PositionP, ODriveObject(/*offset=*/8, /*length=*/32) },
    { ODriveObjectName::PositionI, ODriveObject(/*offset=*/12, /*length=*/32) },
    { ODriveObjectName::PositionD, ODriveObject(/*offset=*/16, /*length=*/32) },
    { ODriveObjectName::RequestedState, ODriveObject(/*offset=*/20, /*length=*/32) },
};

ODrivePDOmap::ObjectMap ODrivePDOmap::mosi_objects_axis_1 = {
    { ODriveObjectName::TargetTorque, ODriveObject(/*offset=*/24, /*length=*/32) },
    { ODriveObjectName::TargetPosition, ODriveObject(/*offset=*/28, /*length=*/32) },gits

    { ODriveObjectName::PositionP, ODriveObject(/*offset=*/32, /*length=*/32) },
    { ODriveObjectName::PositionI, ODriveObject(/*offset=*/36, /*length=*/32) },
    { ODriveObjectName::PositionD, ODriveObject(/*offset=*/40, /*length=*/32) },
