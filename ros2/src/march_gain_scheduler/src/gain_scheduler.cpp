...
// std::vector<float> GainScheduler::calculateComDistance(const std::string& joint_name, double joint_angle) {
//     std::vector<float> ComDistance;
//     if (joint_name == "ankle"){
...
float GainScheduler::calculateInertia(double mass, double distance) {
