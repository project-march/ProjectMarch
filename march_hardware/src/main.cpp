...
int main(int argc, char** argv)
{
  ...
  while (a < 3)
  {
    ...
    ROS_INFO("march4.getPowerDistributionBoard()->getLowVoltage().getNetCurrent(1) "
             "%f",
    ...
    //   All gets:
    ROS_INFO_STREAM("getHighVoltage " << march4.getPowerDistributionBoard()->getHighVoltage());
    ROS_INFO_STREAM("getLowVoltage " << march4.getPowerDistributionBoard()->getLowVoltage());
    ROS_INFO("getNetOperational 1 %d", march4.getPowerDistributionBoard()->getHighVoltage().getNetOperational(1));
    ROS_INFO("getNetOperational 2 %d", march4.getPowerDistributionBoard()->getHighVoltage().getNetOperational(2));
    // 1-8
    ROS_INFO("getOvercurrentTrigger 1 %d",
             march4.getPowerDistributionBoard()->getHighVoltage().getOvercurrentTrigger(1));
    // 1-8
    march4.getPowerDistributionBoard()->getHighVoltage().getNetCurrent();
    march4.getPowerDistributionBoard()->getHighVoltage().getHighVoltageEnabled();
