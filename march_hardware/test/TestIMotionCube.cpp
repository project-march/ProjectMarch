...
{
  ASSERT_THROW(march::IMotionCube(1, nullptr, std::move(this->mock_incremental_encoder),
...
{
  ASSERT_THROW(march::IMotionCube(1, std::move(this->mock_absolute_encoder), nullptr,
                                  march::ActuationMode::unknown),
               std::invalid_argument);
}
