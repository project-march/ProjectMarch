...
class SubgaitGraphTest(unittest.TestCase):
    @parameterized.expand(
        [
            ...
            (
                ...
                {
                    "start": {"to": "1"},
                    "1": {"to": "end", "increase_size": "2", "decrease_size": "3"},
                    "2": {"to": "end"},
                    "3": {"to": "end"},
                },
            ),
    ...
    @parameterized.expand(
        [
            ...
            (
                "invalid transitions",
                {"start": {"to": "1"}, "1": {"to": "end", "from": "start"}},
            ),
            (
                "equal transitions",
                {"start": {"to": "1", "stop": "1"}, "1": {"to": "end"}},
            ),
            (
            ...
            (
                "transition to start",
                {"start": {"to": "1"}, "1": {"to": "start", "stop": "end"}},
            ),
            (
                "no transitions to end",
                {"start": {"to": "1"}, "1": {"to": "2"}, "2": {"to": "1"}},
            ),
            (
            ...
            (
                "not all reachable from start",
                {"start": {"to": "1"}, "1": {"to": "end"}, "2": {"to": "end"}},
            ),
        ]
    )
    ...
    def test_get_correct_stop_transition(self):
        ...
        graph = SubgaitGraph(
            {
                "start": {"to": subgait},
                subgait: {"to": "end", "stop": stop_subgait},
                stop_subgait: {"to": "end"},
            }
        )
    ...
    def test_iter_transitions(self):
        ...
        self.assertSetEqual(
            set(iter(graph)), {("start", "1"), ("1", "2"), ("2", "1"), ("2", "end")}
        )
    ...
    def test_iter_transitions_with_increase_decrease(self):
        ...
        self.assertSetEqual(
            set(iter(graph)), {("start", "1"), ("1", "end"), ("2", "end"), ("3", "end")}
        )
