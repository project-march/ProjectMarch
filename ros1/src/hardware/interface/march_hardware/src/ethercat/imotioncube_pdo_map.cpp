...
std::unordered_map<IMCObjectName, IMCObject> IMCPDOmap::all_objects = {
    { IMCObjectName::StatusWord, IMCObject(/*_address=*/0x6041, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::ActualPosition, IMCObject(/*_address=*/0x6064, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::ActualVelocity, IMCObject(/*_address=*/0x6069, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::MotionErrorRegister, IMCObject(/*_address=*/0x2000, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::DetailedErrorRegister, IMCObject(/*_address=*/0x2002, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::SecondDetailedErrorRegister, IMCObject(/*_address=*/0x2009, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::DCLinkVoltage, IMCObject(/*_address=*/0x2055, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::DriveTemperature, IMCObject(/*_address=*/0x2058, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::ActualTorque, IMCObject(/*_address=*/0x6077, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::CurrentLimit, IMCObject(/*_address=*/0x207F, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::MotorPosition, IMCObject(/*_address=*/0x2088, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::MotorVelocity, IMCObject(/*_address=*/0x2087, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::ControlWord, IMCObject(/*_address=*/0x6040, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::TargetPosition, IMCObject(/*_address=*/0x607A, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::TargetTorque, IMCObject(/*_address=*/0x6071, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::QuickStopDeceleration, IMCObject(/*_address=*/0x6085, /*_sub_index=*/0, /*_length=*/32) },
    { IMCObjectName::QuickStopOption, IMCObject(/*_address=*/0x605A, /*_sub_index=*/0, /*_length=*/16) },
    { IMCObjectName::MotorVoltage, IMCObject(/*_address=*/0x2108, /*_sub_index=*/3, /*_length=*/16) }
};
...
std::unordered_map<IMCObjectName, uint8_t> IMCPDOmap::map(SdoSlaveInterface& sdo, DataDirection direction)
{
    switch (direction) {
        case DataDirection::MISO:
            return configurePDO(sdo, /*base_register=*/0x1A00, /*base_sync_manager=*/0x1C13);
        case DataDirection::MOSI:
            return configurePDO(sdo, /*base_register=*/0x1600, /*base_sync_manager=*/0x1C12);
        default:
