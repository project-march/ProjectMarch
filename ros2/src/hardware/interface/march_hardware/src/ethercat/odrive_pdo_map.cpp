...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_0
    = { { ODriveObjectName::AbsolutePosition, ODriveObject(/*offset=*/0, /*length=*/32) },
          ...
          { ODriveObjectName::MotorError, ODriveObject(/*offset=*/20, /*length=*/32) },
          { ODriveObjectName::EncoderError, ODriveObject(/*offset=*/24, /*length=*/32) },
          { ODriveObjectName::TorqueSensorError, ODriveObject(/*offset=*/28, /*length=*/32) },
          { ODriveObjectName::ControllerError, ODriveObject(/*offset=*/32, /*length=*/32) },
          { ODriveObjectName::DieBOSlaveError, ODriveObject(/*offset=*/36, /*length=*/32) },
...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_1
    = { { ODriveObjectName::AbsolutePosition, ODriveObject(/*offset=*/60, /*length=*/32) },
          ...
          { ODriveObjectName::MotorError, ODriveObject(/*offset=*/80, /*length=*/32) },
          { ODriveObjectName::EncoderError, ODriveObject(/*offset=*/84, /*length=*/32) },
          { ODriveObjectName::TorqueSensorError, ODriveObject(/*offset=*/88, /*length=*/32) }, 
          { ODriveObjectName::ControllerError, ODriveObject(/*offset=*/92, /*length=*/32) },
          { ODriveObjectName::DieBOSlaveError, ODriveObject(/*offset=*/96, /*length=*/32) },
...
ODrivePDOmap::ObjectMap ODrivePDOmap::miso_objects_axis_none
    = { { ODriveObjectName::Heel_right, ODriveObject(/*offset=*/120, /*length=*/32) },
          { ODriveObjectName::Heel_left, ODriveObject(/*offset=*/124, /*length=*/32) },
          { ODriveObjectName::Met1, ODriveObject(/*offset=*/128, /*length=*/32) },
          { ODriveObjectName::Hallux, ODriveObject(/*offset=*/132, /*length=*/32) },
          { ODriveObjectName::Met3, ODriveObject(/*offset=*/136, /*length=*/32) },
          { ODriveObjectName::Toes, ODriveObject(/*offset=*/140, /*length=*/32) },
          { ODriveObjectName::Met5, ODriveObject(/*offset=*/144, /*length=*/32) },
          { ODriveObjectName::Arch, ODriveObject(/*offset=*/148, /*length=*/32) },
          { ODriveObjectName::Rfix, ODriveObject(/*offset=*/152, /*length=*/32) } };
