...
TEST_F(FootstepGeneratorTest, getStanceFootstepsTest)
{
    double expected_dist_x = this->footstep_gen->get_velocity_x();
    double expected_dist_y = this->footstep_gen->get_velocity_y();
    const double margin = 0.5;

    geometry_msgs::msg::PoseArray footsteps = this->footstep_gen->generate_foot_placements(1, 1);
