...
protected:
    ...
    march::AbsoluteEncoder encoder = march::AbsoluteEncoder(counts_per_rotation, motor_controller_type,
        lower_limit_iu, upper_limit_iu, zero_position_iu,
        lower_error_soft_limit_rad_diff, upper_error_soft_limit_rad_diff,
...
{
    ASSERT_THROW(
        march::AbsoluteEncoder(this->counts_per_rotation, motor_controller_type, this->upper_limit_iu, this->lower_limit_iu,
            this->zero_position_iu, this->lower_error_soft_limit_rad_diff, this->upper_error_soft_limit_rad_diff, this->lower_soft_limit_rad_diff, this->upper_soft_limit_rad_diff),
...
TEST_F(AbsoluteEncoderTest, LowerSoftLimitLowerThanLowerHardLimit)
{
    ASSERT_THROW(march::AbsoluteEncoder(this->counts_per_rotation, motor_controller_type, this->lower_limit_iu,
                     this->upper_limit_iu, this->zero_position_iu, this->lower_error_soft_limit_rad_diff, this->upper_error_soft_limit_rad_diff, -1.0, this->upper_soft_limit_rad_diff),
        march::error::HardwareException);
}
...
{
    ASSERT_THROW(march::AbsoluteEncoder(this->counts_per_rotation, motor_controller_type, this->lower_limit_iu,
                     this->upper_limit_iu, this->zero_position_iu, this->lower_error_soft_limit_rad_diff, this->upper_error_soft_limit_rad_diff, this->lower_soft_limit_rad_diff, 5.0),
        march::error::HardwareException);
}
