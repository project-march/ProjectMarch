...
class IKSolverNode : public rclcpp::Node
{
    ...
    private:
        ...
        control_msgs::msg::JointTrajectoryControllerState convertToJointTrajectoryControllerStateMsg();
        ...
        rclcpp::Publisher<control_msgs::msg::JointTrajectoryControllerState>::SharedPtr joint_trajectory_controller_state_pub_;
