...
int LaunchParameters::numberOfJoints, LaunchParameters::numberOfGES, LaunchParameters::numberOfPdb,
    LaunchParameters::numberOfIpd,

    LaunchParameters::ethercatCycleTime, LaunchParameters::ethercatFrequency;

vector<string> LaunchParameters::listOfJoints, LaunchParameters::listOfGES, LaunchParameters::listOfSlaves;
