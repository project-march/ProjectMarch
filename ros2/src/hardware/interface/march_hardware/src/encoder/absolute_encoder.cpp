...
AbsoluteEncoder::AbsoluteEncoder(size_t counts_per_rotation, MotorControllerType motor_controller_type,
    ...
    double lower_error_soft_limit_rad_diff, double upper_error_soft_limit_rad_diff, double lower_soft_limit_rad_diff,
    double upper_soft_limit_rad_diff)
    ...
    , upper_hard_limit_iu_(upper_limit_iu)
{
    ...
    inputSanityCheck(lower_error_soft_limit_rad_diff, upper_error_soft_limit_rad_diff, lower_soft_limit_rad_diff,
        upper_soft_limit_rad_diff);
}

AbsoluteEncoder::AbsoluteEncoder(size_t counts_per_rotation, MotorControllerType motor_controller_type,
    int32_t lower_limit_iu, int32_t upper_limit_iu, int32_t zero_position_iu, double lower_error_soft_limit_rad_diff,
    ...
    : AbsoluteEncoder(counts_per_rotation, motor_controller_type, Direction::Positive, lower_limit_iu, upper_limit_iu,
        zero_position_iu, lower_error_soft_limit_rad_diff, upper_error_soft_limit_rad_diff, lower_soft_limit_rad_diff,
        upper_soft_limit_rad_diff)
{
}
    ...
    double lower_soft_limit_rad_diff, double upper_soft_limit_rad_diff) const
{
    ...
    if (lower_error_soft_limit_iu_ >= upper_error_soft_limit_iu_) {
        throw error::HardwareException(error::ErrorType::INVALID_RANGE_OF_MOTION,
            ...
            lower_error_soft_limit_iu_, lower_error_soft_limit_rad_diff, upper_error_soft_limit_iu_,
            upper_error_soft_limit_rad_diff);
    }
}
