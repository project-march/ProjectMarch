...
public:
    SolverNode()
    : Node("solver_node") {
        robot_state_subscriber = this->create_subscription<march_shared_msgs::msg::RobotState>("robot_state", 10,
            std::bind(&SolverNode::robot_state_callback, this, _1));
        gait_subscriber = this->create_subscription<trajectory_msgs::msg::JointTrajectory>("gait", 10,
            std::bind(&SolverNode::gait_callback, this, _1));
