...
void WeightShiftBuffer::fix_timings_traj()
{
    ...
    //     m_final_joint_trajectory.points[i].time_from_start.nanosec = (i * duration_one_point - floorf(i * duration_one_point)) * 1e8;
    ...
    for (int i = m_duration_weight_shift*10; i<(m_duration_weight_shift*10 + m_incoming_joint_trajectory.points.size()); i++){
    ...
    for (int i = (m_duration_weight_shift*10 + m_incoming_joint_trajectory.points.size()); i< m_final_joint_trajectory.points.size(); i++)
    {
        m_final_joint_trajectory.points[i].time_from_start.sec = i * duration_one_point;
        m_final_joint_trajectory.points[i].time_from_start.nanosec = (i * duration_one_point - floorf(i * duration_one_point)) * 1e8;
    }
