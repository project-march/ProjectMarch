...
void ComControllerPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
{
    ...
    ros::SubscribeOptions so
        = ros::SubscribeOptions::create<march_shared_msgs::CurrentGait>("/march/gait_selection/current_gait",
            /*queue_size=*/1, boost::bind(&ComControllerPlugin::onRosMsg, this, _1), ros::VoidPtr(), &ros_queue_);
    ...
    if (ros_node_->param("/balance", balance, false)) {
        ...
        boost::function<bool(march_shared_msgs::ChangeComLevel::Request&, march_shared_msgs::ChangeComLevel::Response&)>
            change_com_cb = boost::bind(&ComControllerPlugin::onChangeComLevel, this, _1, _2);
        ...
        boost::function<bool(
            march_shared_msgs::GetPossibleComLevels::Request&, march_shared_msgs::GetPossibleComLevels::Response&)>
