//
// Created by Marco on 28-11-22.
//

#ifndef MARCH_HARDWARE_INTERFACE__MARCH_MUJOCO_SYSTEM_INTERFACE_HPP_
#define MARCH_HARDWARE_INTERFACE__MARCH_MUJOCO_SYSTEM_INTERFACE_HPP_
...
class MarchMujocoSystemInterface : public hardware_interface::BaseInterface<hardware_interface::SystemInterface> {
public:
    RCLCPP_SHARED_PTR_DEFINITIONS(MarchMujocoSystemInterface);

    MARCH_HARDWARE_INTERFACE_PUBLIC MarchMujocoSystemInterface();

    MARCH_HARDWARE_INTERFACE_PUBLIC ~MarchMujocoSystemInterface() override;
...
#endif // MARCH_HARDWARE_INTERFACE__MARCH_MUJOCO_SYSTEM_INTERFACE_HPP_
